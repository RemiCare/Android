    ...
    <Modal transparent animationType="fade" visible={true}>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { borderColor: T.red, borderWidth: 2 }]}>
          ...
          <View style={styles.modalButtons}>
            <TouchableOpacity onPress={onClose} style={styles.modalCloseBtn}>
              <Text style={styles.modalCloseTxt}>상황 해제</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={onCall} style={[styles.modalMuteBtn, { backgroundColor: T.red, borderColor: T.red }]}>
              <Text style={[styles.modalMuteTxt, { color: "#fff", fontWeight: "700" }]}>📞 비상 통화</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
