      ...
      <View style={{ paddingVertical: 14, paddingHorizontal: 16 }}>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", gap: 10 }}>
          {[
            ...
            <View key={v.label} style={{ width: "48%", backgroundColor: T.bg3, borderRadius: T.r.md, paddingVertical: 12, paddingHorizontal: 11, marginBottom: 4 }}>
              <Text style={{ fontSize: 10, color: v.color, fontWeight: "700", marginBottom: 4, opacity: 0.8 }}>{v.icon} {v.label}</Text>
              <View style={{ flexDirection: "row", alignItems: "baseline", gap: 2 }}>
                <Text style={{ fontSize: 16, fontWeight: "700", color: v.color }}>{v.val}</Text>
